...
import com.matejdro.pebble.common.crashreport.R
import com.matejdro.pebble.common.logging.FileLoggingControllerImpl
...
class CrashReportActivity : ComponentActivity() {
   override fun onCreate(savedInstanceState: Bundle?) {
      ...
      val themeProvider = application as CrashWindowThemeProvider
...
private fun CrashReportPreview() {
   ...
   MaterialTheme {
      Column(verticalArrangement = Arrangement.spacedBy(16.dp), modifier = Modifier.padding(16.dp)) {
         ErrorReport(errorText, "My Pebble App", {}, {}, {})
      }
   }
}
